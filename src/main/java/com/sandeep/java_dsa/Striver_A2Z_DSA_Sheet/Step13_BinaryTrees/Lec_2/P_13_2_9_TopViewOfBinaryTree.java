...
public class P_13_2_9_TopViewOfBinaryTree {
    ...
    public static List<Integer> levelOrder(Node root){
        ...
        while (!queue.isEmpty()){
            ...
            if(!map.containsKey(current.getRight())) map.put(current.getRight(), current.getLeft().val);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Top-View of Binary Tree: " + levelOrder(root));
    }
}